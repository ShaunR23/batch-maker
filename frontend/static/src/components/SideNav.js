...
<ul className="w-1/2 pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700"></ul>
</li>
<li>
<a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
<span className="flex-1 ml-3 whitespace-nowrap">Public Recipes</span>
...
<span className="flex-1 ml-3 whitespace-nowrap">Popular Recipes</span>
...
<span className="flex-1 ml-3 whitespace-nowrap">My Favorite Recipes</span>
</a>
<ul className="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700"></ul>
</li>
<li>
...
<span className="flex-1 ml-3 whitespace-nowrap">My Pantry</span>
</a>
</li>
